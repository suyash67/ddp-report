...
\newcommand{\cL}{\textbf{c}_L}
\newcommand{\cR}{\textbf{c}_R}
...
\algnewcommand\algorithmicprotocol{\textbf{Protocol:}}
\algnewcommand\PROTOCOL{\item[\algorithmicprotocol]}
...
\newcommand{\pro}{\textcolor{green}{\cmark}}
\newcommand{\con}{\textcolor{red}{\xmark}}
...
%                         Title Page                            
%*******************************************************************
\title{A Proof of Reserves Protocol with Short Proofs and a Method to Estimate Amount Upper Bounds for MimbleWimble}
\author{Suyash Bagad}
...
\include{prelims/crypto_prelims}
\include{lit/literature}
\include{revelioBP/reveliobp}
\include{grin-ub/grin_ub}
