...
\usepackage{pgfplots}
\pgfplotsset{width=1.32\textwidth,compat=1.9}
\usetikzlibrary{spy}
...
% \newcommand{\Iproto}{$\Uppi_{\RBmath}^{I}$ }
% \newcommand{\Iprotow}{$\Uppi_{\RBmath}^{I}$}

\newcommand{\lang}{$\L_{\RBmath}$ }
% \newcommand{\Ilang}{$\L_{\RBmath}^I$ }
\newcommand{\langw}{$\L_{\RBmath}$}
% \newcommand{\Ilangw}{$\L_{\RBmath}^I$}
