\chapter{\textnormal{{\fontfamily{qag}\selectfont RevelioBP}} - MimbleWimble Proof of Reserves Protocol with Short Proofs}
\label{chap:revBP}
  ...
  \begin{subfigure}[b]{0.49\textwidth}
    ...
    \begin{tikzpicture}
      ...
      \addplot+[
          ...
          % Correction in Revelio proof size: 33*(6n+1)/1000
          (	100	,	19.833	)
          (	200	,	39.633	)
          (	400	,	79.233	)
          (	800	,	158.433	)
